...
export const MessageIcon = ({ className, width = '2.3rem', height = '2.3rem' }) => {
   return (
      <svg
         className={className}
         width={width}
...
export const FollowingIcon = ({ className, width = '2.3rem', height = '2.3rem' }) => {
   return (
      <svg
         width={width}
         height={height}
...
export const LiveIcon = ({ className, width = '2.3rem', height = '2.3rem' }) => {
   return (
      <svg
         width={width}
         height={height}
